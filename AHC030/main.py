...
#     print("# EDGE : ",edge)
#     ci, cj = edge.pop(0)
#     if is_opened[ci][cj] == 0:
#         is_opened[ci][cj] = 1
#         res = query_dig(points=[[ci, cj]])
#         if res > 0:
#             for d in d4:
#                 ni = ci + d[0]
#                 nj = cj + d[1]
#                 if 0 <= ni < N and 0 <= nj < N and is_opened[ni][nj] == 0:
#                     edge.append([ni,nj])
#             print("#c", ci, cj, "green")
#             found_all_cnt += res
#             print("# found/all (EDGE)",found_all_cnt,ALL_OIL)
#             is_oil[ci][cj] = 1
#             ans.append([ci, cj])
#             if found_all_cnt >= ALL_OIL: ans_exit(ans)
#         else:
